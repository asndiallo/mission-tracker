...
export const roadmapPhases: DetailedPhase[] = [
  {
    ...
    description: "Ship mentally, physically, and administratively ready. Understand the nursing pathway before you commit.",
    objective: "Ship mentally, physically, and administratively ready. Understand the nursing pathway before you commit.",
    ...
    checklists: [
      {
        ...
        items: [
          ...
          { text: "Gather all citizenship documents (digital + physical)", completed: false },
          { text: "Pay off high-interest debt", completed: false },
          { text: "Set up direct deposit + high-yield savings", completed: false },
          { text: "Have 'real talk' with fiancée about military life + nursing school", completed: false },
          { text: "Shadow a nurse or volunteer in healthcare setting", completed: false },
  ...
  },
  {
    ...
    objective: "Graduate BMT with strong evaluations. Initiate citizenship process. Build reputation as a leader.",
  ...
  },
  {
    ...
    description: "Medical training at Fort Sam Houston, Texas (Joint Base San Antonio)",
    objective: "Graduate top of class. Earn CCAF credits. Begin nursing prerequisites research. Confirm you like clinical medicine.",
    ...
    checklists: [
      {
        ...
        items: [
          { text: "Graduate 4N0 tech school (top 10% if possible)", completed: false },
          { text: "Obtain official CCAF transcript", completed: false },
          { text: "Confirm which tech school credits transfer to BSN prerequisites", completed: false },
          { text: "Shadow nurses during clinicals (confirm you like patient care)", completed: false },
    ...
    successMetrics: [
      ...
      { metric: "Confirmed interest in nursing (vs. HIM or other fields)", achieved: false },
  ...
  },
  {
    ...
    description: "Marry, excel at work, start prerequisites, build credit and emergency fund",
    objective: "Marry. Excel at duty station. Complete 21 credits of nursing prerequisites. Build financial foundation.",
    ...
    checklists: [
      {
        ...
        items: [
          ...
          { text: "Finish 21 credits of nursing prerequisites (GPA 3.5+)", completed: false },
          { text: "Build credit to 700+", completed: false },
          { text: "Save $5,000 emergency fund", completed: false },
          { text: "Volunteer for extra duties (build EPR bullets)", completed: false }
        ]
      }
    ],
    successMetrics: [
      { metric: "Married with spouse at duty station", target: "Jun 2027", achieved: false },
  ...
  },
  {
    ...
    description: "Complete prerequisites, apply for AECP, promote to SSgt, buy first property",
    objective: "Complete all nursing prerequisites. Submit AECP application. Promote to SSgt. Buy first property.",
    ...
    checklists: [
      {
        ...
        items: [
          { text: "Complete final 10 credits of prerequisites (GPA 3.5+)", completed: false },
          { text: "Submit AECP application (Feb-Apr 2028)", completed: false },
          { text: "Promote to SSgt (or test for it)", completed: false },
          { text: "Buy first property using VA loan (Q4 2027 - Q1 2028)", completed: false },
          { text: "Get tenants in place (Q2 2028)", completed: false },
          { text: "Maintain excellent EPRs", completed: false },
          { text: "Build relationship with commander (strong rec letter)", completed: false }
        ]
      }
    ],
    successMetrics: [
      { metric: "All nursing prerequisites completed", target: "31 credits, GPA 3.5+", achieved: false },
      { metric: "AECP application submitted", achieved: false },
      { metric: "SSgt rank achieved (E-5)", achieved: false },
      { metric: "First property purchased + tenants in place", achieved: false },
  ...
  },
  {
    ...
    description: "Accelerated BSN program as AECP selectee, receiving full E-5 pay + tuition covered",
    objective: "Graduate BSN. Pass NCLEX. Commission as Nurse Corps Officer (O-1).",
    ...
    checklists: [
      {
        ...
        items: [
          { text: "Complete Fall, Spring, Summer semesters (GPA 3.0+ required)", completed: false },
          { text: "Log 250+ clinical hours", completed: false },
          { text: "Pass all nursing exams (75%+ to pass each course)", completed: false },
          { text: "Pass Air Force PT test (if tested)", completed: false },
          { text: "Maintain relationship with spouse", completed: false },
          { text: "Keep property cashflowing (if applicable)", completed: false }
        ]
      },
      {
        ...
        items: [
          ...
          { text: "Commission as Nurse Corps Officer, O-1 (Aug 2030)", completed: false },
  ...
  },
  {
    ...
    description: "Part-time BSN while working full-time, leading to direct commission",
    objective: "Finish BSN using TA + GI Bill. Pass NCLEX. Apply for direct commission.",
    start_date: "2028-09-01",
    end_date: "2031-12-31",
    status: "upcoming",
    sections: [
    ...
    successMetrics: [
      { metric: "BSN degree earned (part-time while working)", achieved: false },
      ...
      { metric: "10 years of service (eligible for retirement at 20)", achieved: false }
    ]
  },
  {
    id: "phase-5",
    name: "Phase 5 — Officer Life: Nurse Corps",
    description: "Build officer career, specialize, expand real estate, prepare for retirement or separation",
    objective: "Build officer career. Specialize. Expand real estate. Prepare for retirement or separation.",
    ...
    checklists: [
      {
        ...
        items: [
          ...
          { text: "Promote to O-2 (automatic after 18 months)", completed: false },
          { text: "Choose clinical specialization", completed: false },
          { text: "Apply for MSN program (CRNA, NP, or other)", completed: false },
          { text: "Buy Property #2", completed: false },
          { text: "Buy Property #3", completed: false },
          { text: "Transfer GI Bill to dependents (if applicable)", completed: false },
          { text: "Promote to O-3 (Captain)", completed: false }
        ]
      }
    ],
    successMetrics: [
      { metric: "Promoted to O-3 (Captain)", target: "After 4 years as O-2", achieved: false },
      { metric: "MSN degree (or in progress)", achieved: false },
      { metric: "Specialty certification (flight nurse, ICU, NP, or CRNA)", achieved: false },
      { metric: "3-4 rental properties", target: "Equity $300k+, cashflow $1,000+/month", achieved: false },
  ...
  },
  {
    ...
    description: "Decide on retirement/separation, achieve financial independence, set up next chapter",
    objective: "Decide on retirement/separation. Achieve financial independence. Set up next chapter.",
    ...
    successMetrics: [
      ...
      { metric: "Passive income from real estate", target: "$12-18k/year", achieved: false },
      { metric: "MSN degree completed", achieved: false },
      { metric: "Decision made on 20-year retirement vs separation", achieved: false },
      { metric: "Legacy plan in place for children's education", achieved: false }
    ],
    decisionPoints: [
      {
        title: "Retirement Decision (Age 37-42)",
        scenario: "After 17+ years of service, you must decide your next chapter",
        ...
        recommendation: "You'll have OPTIONS. You're not trapped. Choose based on your family's needs and financial goals."
      }
    ]
  }
];
...
export function getRoadmapStats() {
  ...
  const activePhases = roadmapPhases.filter(p => p.status === "active").length;
  const completedPhases = roadmapPhases.filter(p => p.status === "complete").length;
  const upcomingPhases = roadmapPhases.filter(p => p.status === "upcoming").length;

  // Find next milestone (first upcoming phase)
  const nextPhase = roadmapPhases.find(p => p.status === "upcoming" || p.status === "active");
